    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                ...
                <a class="btn btn-link" href="/pizzawinkel_app/">Home</a>
                <a class="btn btn-link" href="/pizzawinkel_app/about.php">About Us</a>
                <a class="btn btn-link" href="/pizzawinkel_app/contact.php">Contact Us</a>
            </div>
            <div class="col-lg-4 col-md-6">
                <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">Contact</h4>
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Vlamingstraat 10, 8560 Wevelgem - Belgium</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+012 345 67890</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@pizziland.com</p>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Pizziland</a>, All Right Reserved.
